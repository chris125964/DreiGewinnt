...
public class Spielfeld {
	...
	private final int SPIELFELD_LAENGE_WAAGRECHT = 3;
	private final int SPIELFELD_LAENGE_SENKRECHT = 3;
	...
	public Spielfeld() {
		...
		this.feld = new ESpielfigur[][] { // int[x][y]
				{ ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT }, // int[0][0-5]
				{ ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT }, // int[1][0-5]
				{ ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT, ESpielfigur.UNDEFINIERT } // int[2][0-5]
		};
